...
"       helpheight: zero disables this
  set   helpheight=0
"
"       hidden: keep buffers open in the background (faster)
  set   hidden
"
...
"       lazyredraw:  do not update screen while executing macros
  set   lazyredraw
"
"       mouse:       only on normal mode
  set   mouse=n
"
"       pastetoggle
  set   pastetoggle=<f11>
"
"       path:   so that 'gf' will find stuff in the lib, too
  set   path=.,~/work/svn/EFS2/lib,~/work/svn/EFS2
"
...
"       commands, ie keep the cursor in the current column.
  set nostartofline
"
"       splitbelow: windows below the current
  set   splitbelow
"
...
"       makeprg: for linting
  set   makeprg=php\ -l\ %
"
"       errorformat: for linting
  set   errorformat=%m\ in\ %f\ on\ line\ %l
"
"
"       iskeyword: adjust word boundaries to include "\" for use with PHP
"       namespaces
...
"
  noremap <C-E>   :set formatoptions=cqrt<c-m>
  noremap <C-C>   :set formatoptions=cqr<c-m>
"
